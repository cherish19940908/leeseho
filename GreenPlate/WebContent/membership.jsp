...
<script>
	...
	function total_check() {
		...
		var niclength = naver.nick.value.length
				...
				<FORM name="naver" action="membershipAction.jsp" method=post>
					<tr>
						<td align="center"><a href="gpindex.jsp"><img
								src="img\\gplogo1.png" style="width: 400px; height: 90px"></a>
						</td>
					</tr>
					...
					<tr>
						<td>
							<div>
								<input type="text" name="age" class="f" placeholder="생년월일을 입력해주세요"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = '생년월일을 입력해 주세요'">
							</div>
