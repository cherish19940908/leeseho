...
%>
	...
	%>
					<tr>
						...
						<td>
							...
							<%}else{ %>
							<%} %> 
							<a href="boardDetail.bo?board_num=<%=articleList.get(i).getQnum()%>&page=<%=nowPage%>">
			...
			<div id="pageList">
				...
				<form method="post" action="boardSearchList.bo">
					...
					<%
							if (id != null) {
						%>
					<a href="boardWriteForm.bo"><button type="button" class="btn btn-success" id="write_button">글작성</button>
				</a>
				<%
						}
					%>
	...
	<%
							if (id != null) {
						%>
	<a href="boardWriteForm.bo"><button type="button" class="btn btn-success" id="write_button">글작성</button></a>
	<%
	}
	}
%>
